...
public class RunoramaCubeMapRenderer extends CubeMapRenderer {
   ...
   public void draw(MinecraftClient minecraftClient_1, float float_1, float float_2, float float_3) {
      ...
      RenderSystem.multMatrix(Matrix4f.method_4929(85.0D, (float)minecraftClient_1.window.getFramebufferWidth() / (float)minecraftClient_1.window.getFramebufferHeight(), 0.05F, 10.0F));
